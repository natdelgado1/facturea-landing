export const faq = {
  // Badge superior
  badgeText: "Resolvé todas tus dudas",
  ...
  // Subtítulo
  description: "Todo lo que necesitás saber sobre",
  descriptionBold1: "adelanto de facturas",
  descriptionAnd: "e",
  descriptionBold2: "inversiones",
  descriptionEnd: "en Paraguay",
  
  // Preguntas frecuentes
  faqs: [
    {
      question: "¿Qué necesito para adelantar una factura?",
      answer: "Solo necesitás R.U.C, cuenta bancaria y ser facturador electrónico. No necesitás historial crediticio ni garantías adicionales. Es así de simple."
    },
    {
    ...
    },
    {
      ...
      answer: "Para los empresas, aplicamos una comisión competitiva y transparente sobre el monto adelantado. Para los inversores, no hay comisiones de registro ni de mantenimiento."
    }
  ],
  ...
  cta: {
    ...
    description: "Nuestro equipo está disponible para resolver todas tus dudas sobre factoring e inversiones",
    buttons: {
      support: "Contactar Soporte",
      whatsapp: "Correo: hola@facturea.io"
    }
  }
};